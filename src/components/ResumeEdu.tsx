...
import { Course } from '../data/lifeApi';
          ...
          <li key={roleIndex} className="flex gap-4">
            ...
            <dl className="flex flex-auto flex-wrap gap-x-2">
              ...
              <dd
                ...
                aria-label={`${role.month} until ${role.year}`}
              >
                <time dateTime={role.month}>{role.month}</time> <span aria-hidden="true">—</span>{' '}
